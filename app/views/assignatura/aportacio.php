	...
	<div class="imgPerfil">
		<?php 
			...
			if($urlImatge == ''){
				...
				//local
				//$urlImatge = '/laravel/public/'.$urlImatge;
		 	}
		?>
		<img				
	...
	if($fitxer!=null){
		...
		<div class="capaAportacio">
			...
			<img src="/laravel/public/img/attach.png" 
					...
					height="16" 
					width="16">
			<a href="<?php echo URL::route('download', array('id' => $id_aportacio))?>" target="_blank">
	...
	<div class="capaAportacio">
				...
				if($aportacio->estudiant_email == Auth::user()->email_estudiant){
					...
					<div style="margin-left:3px; display:inline-block; margin-bottom:3px;">			
						<div class="btn-group">
							...
							href="<?php echo route('aportacio.editar', array('id' => $aportacio->getID())) ?>">
										Editar aportación
									</a>
								</li>
								<li>
									<a data-elimina-aportacio="<?php echo $aportacio->getID()?>"
							href="<?php echo route('aportacio.eliminar', array('id' => $aportacio->getID())) ?>">
										Eliminar aportación
									</a>
								</li>
							</ul>
		...
		<div class="resposta">
			...
			echo Form::open(array('class' => 'form-signin', 
								...
								'autocomplete' => 'off',
								'url' => route('comentari.create', array('id' => $aportacio->getID()))
								));?>	
